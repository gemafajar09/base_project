...
// =======================REGISTER=========================================
Route::get('/admin/register', 'Auth\LoginController@register')->name('admin.register');
Route::post('/admin/aksiregister', 'Auth\LoginController@aksiregister')->name('admin.aksiregister');
